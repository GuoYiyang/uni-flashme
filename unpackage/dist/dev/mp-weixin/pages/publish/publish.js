...
var _publish = _interopRequireDefault(__webpack_require__(/*! ./pages/publish/publish.vue */ 213));
// @ts-ignore
...
/* harmony import */ var _publish_vue_vue_type_template_id_177a8126___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./publish.vue?vue&type=template&id=177a8126& */ 214);
...
/* harmony import */ var _publish_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./publish.vue?vue&type=style&index=0&lang=css& */ 218);
...
try {
  components = {
    ...
    uniFilePicker: function () {
      return Promise.all(/*! import() | uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue */ 460))
    },
    uniForms: function () {
...
var _upload = _interopRequireDefault(__webpack_require__(/*! ../../uni_modules/uview-ui/libs/config/props/upload */ 157));
//
//
//
//
  ...
  methods: {
    ...
    seleteImage: function seleteImage(e) {
      ...
      e.tempFilePaths.map(function (item) {
        _this.imagePathList.push(item);
      });
      e.tempFiles.map(function (item) {
        _this.imageNameList.push(item.name);
      });
    },
    deleteImage: function deleteImage(e) {
      ...
      this.imagePathList.map(function (item, i) {
        if (item == e.tempFilePath) {
          _this2.imagePathList.splice(i, 1);
        }
      });
      this.imageNameList.map(function (item, i) {
        if (item == e.tempFile.name) {
          _this2.imageNameList.splice(i, 1);
        }
      });
    },
