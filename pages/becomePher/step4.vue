<template>
	<view>
		<view style="margin: 40px 0 40px 0;">
			<u-steps current="2" inactiveColor="#3D6EC2" activeColor="#3D6EC2">
		...
		<view>
			...
			<view @click="toStep5"
				style="display: flex;justify-content:center;font-weight: 550;font-size: 15px;line-height: 20px;color:#3D6EC2;">
				稍后设置
			</view>
