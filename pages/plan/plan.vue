<template>
	<view>
		<view style="padding: 30px 24px 28px 24px;background: #FFFFFF;border-radius: 12px;">

			<view style="font-weight: 500;font-size: 16px;line-height: 16px;color: #191919;flex-flow: row;">
				拍摄方案
			...
			<view style="margin: 20px 0 20px 0;">
				<u-scroll-list :indicator="false">
					<view v-if="planList.length == 0" @click="addPlan"
						style="padding: 28px 20px 28px 20px; margin: 8px;width: 212px;height: 340px;background: #F8F9FA;box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.20);border-radius: 10px;">
						<view
			...
			<view style="font-weight: 500;font-size: 16px;line-height: 16px;color: #191919;">
				拍摄须知
			</view>
			<view style="margin: 20px 0px 20px 0px;">
				<view v-if="notice==null || notice == ''" @click="addNotice"
					...
					<view
						...
						<view
							style="font-weight: 350;font-size: 13px;line-height: 18px;text-align: center;color:#808080;">
							暂无拍摄须知</view>
					</view>
				</view>
				<view v-if="notice != null" @click="addNotice"
					style="padding: 20px;background-color: #F8F9FA;display: flex">
					<text style="font-weight: 340;font-size: 14px;color: #4E4E4E;line-height: 160%;">{{notice}}</text>
				</view>
			</view>


			<view style="font-weight: 300;font-size: 13px;line-height: 16px;color: #808080">
				*拍摄方案将展示在你的摄影师主页
			</view>
